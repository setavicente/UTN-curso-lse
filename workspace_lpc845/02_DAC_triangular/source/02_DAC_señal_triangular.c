...
int main(void) {
	...
	SysTick_Config(SystemCoreClock / 100000); //cada interrupcion se hace cada 1/100000 seg, osea 10uS
 ...
 */
void SysTick_Handler(void) { //me creo una señal triangular
	// Valor del DAC
